...
function matrix_turn_x (m, cosA, sinA)
{
    let m01, m02;
    let m11, m12;
    let m21, m22;
 ...
 */ 
function matrix_turn_y (m, cosA, sinA)
{
    let m00, m02;
    let m10, m12;
    let m20, m22;
 ...
 *
 */ 
function matrix_turn_z (m, cosA, sinA)
{
    let m00, m01;
    let m10, m11;
    let m20, m21;
...
***********************************************************/
function matrix_translate (m, x, y, z)
{
    let m00, m01, m02, m03;
    let m04, m05, m06, m07;
    let m08, m09, m10, m11;
...
/************************************************************
  Rotate Matrix
    ...
    m15 = m15
***********************************************************/
function matrix_rotate (m, angle, x, y, z)
{
    let v = [0, 0, 0], angleRadian;
    let sinA, cosA, cosA2;
...
/******************************************
   Model Lookat Matrix
*******************************************/
function matrix_modellookat (m, src_pos, tgt_pos, twist)
{
    let deltaV = [0, 0];
 ...
 */
function matrix_multvec2 (m, svec, dvec)
{
    let v0 = svec[0];
    let v1 = svec[1];
...
function matrix_multvec4 (m, svec, dvec)
{
    let v0 = svec[0];
    let v1 = svec[1];
    let v2 = svec[2];
...
function matrix_proj_frustum (mat, left, right, bottom, top, znear, zfar)
{
...
function matrix_proj_perspective (mat, fovy, aspect, znear, zfar)
{
    let a,b,c,d,f;
...
function matrix_proj_ortho (mat, left, right, bottom, top, znear, zfar)
{
    mat[ 0] = mat[ 1] = mat[ 2] = mat[ 3] =
    mat[ 4] = mat[ 5] = mat[ 6] = mat[ 7] =
    mat[ 8] = mat[ 9] = mat[10] = mat[11] =
